...
#define TM_ROM_MINIMUM_SIZE     0x00004000
...
{
    TM_INSTRUCTION_NOP = 0x0000,
    TM_INSTRUCTION_STOP = 0x0100,
    TM_INSTRUCTION_HALT = 0x0200,
    TM_INSTRUCTION_SEC = 0x0300,
    TM_INSTRUCTION_CEC = 0x0400,
    TM_INSTRUCTION_DI = 0x0500,
    TM_INSTRUCTION_EI = 0x0600,
    TM_INSTRUCTION_DAA = 0x0700,
    TM_INSTRUCTION_CPL = 0x0800,
    TM_INSTRUCTION_CPW = 0x0900,
    TM_INSTRUCTION_CPB = 0x0A00,
    TM_INSTRUCTION_SCF = 0x0B00,
    TM_INSTRUCTION_CCF = 0x0C00,
    TM_INSTRUCTION_LD = 0x1000,
    TM_INSTRUCTION_LDQ = 0x1300,
    TM_INSTRUCTION_LDH = 0x1500,
    TM_INSTRUCTION_ST = 0x1700,
    TM_INSTRUCTION_STQ = 0x1900,
    TM_INSTRUCTION_STH = 0x1B00,
    TM_INSTRUCTION_MV = 0x1D00,
    TM_INSTRUCTION_PUSH = 0x1E00,
    TM_INSTRUCTION_POP = 0x1F00,
    TM_INSTRUCTION_JMP = 0x2000,
    TM_INSTRUCTION_JPB = 0x2200,
    TM_INSTRUCTION_CALL = 0x2300,
    TM_INSTRUCTION_RST = 0x2400,
    TM_INSTRUCTION_RET = 0x2500,
    TM_INSTRUCTION_RETI = 0x2600,
    TM_INSTRUCTION_INC = 0x3000,
    TM_INSTRUCTION_DEC = 0x3200,
    TM_INSTRUCTION_ADD = 0x3400,
    TM_INSTRUCTION_ADC = 0x3700,
    TM_INSTRUCTION_SUB = 0x3A00,
    TM_INSTRUCTION_SBC = 0x3D00,
    TM_INSTRUCTION_AND = 0x4000,
    TM_INSTRUCTION_OR = 0x4300,
    TM_INSTRUCTION_XOR = 0x4600,
    TM_INSTRUCTION_CMP = 0x4900,
    TM_INSTRUCTION_SLA = 0x5000,
    TM_INSTRUCTION_SRA = 0x5200,
    TM_INSTRUCTION_SRL = 0x5400,
    TM_INSTRUCTION_RL = 0x5600,
    TM_INSTRUCTION_RLC = 0x5800,
    TM_INSTRUCTION_RR = 0x5A00,
    TM_INSTRUCTION_RRC = 0x5C00,
    TM_INSTRUCTION_BIT = 0x6000,
    TM_INSTRUCTION_SET = 0x6200,
    TM_INSTRUCTION_RES = 0x6400,
    TM_INSTRUCTION_SWAP = 0x6600,
    TM_INSTRUCTION_JPS = 0xFFFF
};
